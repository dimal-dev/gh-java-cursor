 ...
 */
final class Version20221007054250 extends AbstractMigration
{
    private const PSIHOLOG_LIST = [
        [
            'id' => Psiholog::PSIHOLOG_ID_YULIYA_KANTAROVICH,
            'email' => 'yuliya-yuliya@gmail.com',
            'role' => Psiholog::ROLE_PSIHOLOG,
            'state' => Psiholog::STATE_ACTIVE,
            'first_name' => 'Юлия',
            'last_name' => 'Кантарович',
            'birth_date' => '1970-01-01 00:00:00',
            'works_from' => '2018-01-01 00:00:00',
            'profile_template' => '013-yuliya-kantarovich',
