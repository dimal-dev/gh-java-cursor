 ...
 */
final class Version20221102124544 extends AbstractMigration
{
    private const PSIHOLOG_LIST = [
        [
            'id' => Psiholog::PSIHOLOG_ID_IRYNA_KOLODA,
            'email' => 'iryna-fake-set-actual-later@gmail.com',
            'role' => Psiholog::ROLE_PSIHOLOG,
            'state' => Psiholog::STATE_ACTIVE,
            'first_name' => 'Ирина',
            'last_name' => 'Колода',
            'birth_date' => '1970-01-01 00:00:00',
            'works_from' => '1970-01-01 00:00:00',
            'profile_template' => '014-iryna-koloda',
