...
|-------|--------|--------|---------------|
| 1 | Project Foundation | NOT_STARTED | `stages/01-project-foundation.md` |
| 2 | Therapist Module | NOT_STARTED | `stages/02-psiholog-module.md` |
| 3 | Landing Module | NOT_STARTED | `stages/03-landing-module.md` |
...
**Current Active Stage:** Stage 1 - Project Foundation  
**Current Sub-Stage:** Not Started  
